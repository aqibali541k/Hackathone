      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-4 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
          <div className="flex items-center gap-4">
            <Avatar size={80} src={profile.avatar} icon={<UserOutlined />} className="shadow-md" />
            <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <ProfileField label="First Name" name="firstName" value={formData.firstName} editMode={editMode} onChange={handleChange} />
          <ProfileField label="Last Name" name="lastName" value={formData.lastName} editMode={editMode} onChange={handleChange} />
          <ProfileField label="Email" name="email" value={formData.email} editMode={editMode} onChange={handleChange} />
          <ProfileField label="Date of Birth" name="dob" value={formData.dob} editMode={editMode} onChange={handleChange} />

          {/* Role editable only for admin */}
          <ProfileField label="Role" name="role" value={formData.role} editMode={editMode && role === "admin"} onChange={handleChange} />
