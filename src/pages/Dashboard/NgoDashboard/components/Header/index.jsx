  ...
  return (
    <header className="h-16 flex items-center justify-between bg-white/70 backdrop-blur-md border-b border-slate-200/60 px-6 sm:px-8 sticky top-0 z-40 shadow-sm transition-all">
      <div className="flex items-center gap-4 flex-1">
        <div className="hidden sm:flex items-center gap-2 bg-slate-100/80 px-3 py-1.5 rounded-full text-slate-500 w-64 border border-transparent focus-within:border-emerald-300 focus-within:bg-white transition-all">
          <SearchOutlined />
          <input 
            type="text" 
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group cursor-pointer">
            <Avatar 
              size={40} 
              src={user?.avatar}
              className="bg-gradient-to-tr from-emerald-600 to-teal-500 font-bold shadow-md ring-2 ring-white"
            >
